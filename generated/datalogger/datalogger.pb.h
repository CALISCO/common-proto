...
#define StatisticalAggregate_init_default        {false, 0, false, 0, false, 0, false, 0}
...
#define CanMessage_init_default                  {false, 0, false, (CanMessage_FrameType)0, false, (CanMessage_RtrType)0, {{NULL}, NULL}}
...
#define StatisticalAggregate_init_zero           {false, 0, false, 0, false, 0, false, 0}
...
#define CanMessage_init_zero                     {false, 0, false, (CanMessage_FrameType)0, false, (CanMessage_RtrType)0, {{NULL}, NULL}}
...
extern const pb_field_t StatisticalAggregate_fields[5];
...
#define StatisticalAggregate_size                24
#define DataloggerRecord_size                    (18 + DataloggerPayload_size)
/* DataloggerPayload_size depends on runtime parameters */
/* CanMessage_size depends on runtime parameters */
#define VoltageReading_size                      28
